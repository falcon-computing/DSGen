...
#define PROCS_ERROR_8(x)                                                       \
  PROCS_ERROR(8, "Kernel function declaration cannot be in header files\n" + x)
#define PROCS_ERROR_9 PROCS_ERROR(9, "Cannot support C/C++ mixed design")
#define PROCS_ERROR_10(x) PROCS_ERROR(10, "Found a class member function " + x)
...
#define PROCS_ERROR_12(x, y)                                                   \
  PROCS_ERROR(                                                                 \
      12,                                                                      \
      "Cannot find a kernel function call following the task pragma " + x +    \
          (y ? MULTIPLE_FUNCITON_CALLS                                         \
             : ".\n  Hint: the task pragma should be placed right before its " \
...
#define PROCS_ERROR_15(x) PROCS_ERROR(15, "TODO") // merged with RPOCS_ERROR_12
...
#define PROCS_ERROR_18(x) PROCS_ERROR(18, "TODO") // merged with PROCS_ERROR_14
...
#define PROCS_ERROR_27(x)                                                      \
  PROCS_ERROR(                                                                 \
      27, "Cannot support returning a pointer or reference in function " + x)
...
#define PROCS_ERROR_37(x)                                                      \
  PROCS_ERROR(37,                                                              \
              "Cannot support a pointer to interface arrays/pointers: \n" + x)
...
#define PROCS_ERROR_46(x)                                                      \
  PROCS_ERROR(46,                                                              \
              "Cannot support reference type at the kernel interface:\n " + x)
...
#define PROCS_ERROR_51(x)                                                      \
  PROCS_ERROR(51, "Cannot support " + x + " because its name is OpenCL keyword")
...
#define PROCS_ERROR_64(x, y)                                                   \
  PROCS_ERROR(64, "Found interface " + x + " and " + y + " are pointer alias")
#define PROCS_ERROR_66(x) PROCS_ERROR(66, "Cannot support pointer cast " + x)
#define PROCS_ERROR_67(x, y)                                                   \
  PROCS_ERROR(67,                                                              \
              "Cannot support implicit function call " + x + " declared in " + \
                  y + "\n" +                                                   \
...
#define MDARR_ERROR_3(x)                                                       \
  MDARR_ERROR(                                                                 \
      3, "Found overflowed dimension size of the interface variable : \n" + x)
...
#define INFTF_ERROR_6(x, y)                                                    \
  INFTF_ERROR(6,                                                               \
              "Found multiple interface pragmas for port " + x + ":\n" + y +   \
...
#define SEPAR_ERROR_3(x) SEPAR_ERROR(3, "Cannot support function pointer: " + x)
...
#define SEPAR_WARNING_2(x, y)                                                  \
  SEPAR_WARNING(2, "Stream channel '" + x +                                    \
                       "' lacks the 'channel_depth' attribute. Set as " + y +  \
                       " by default.\n")
...
#define RUNTM_ERROR_6(x)                                                       \
  RUNTM_ERROR(                                                                 \
      6, "Cannot find the unique actual declaration for the variable: " + x +)
...
#define POSTW_ERROR_2(x)                                                       \
  POSTW_ERROR(2,                                                               \
              "Kernel return expresion can not be aggregate initilizer: " + x)
...
#define BURST_INFO_1(x, z, y)                                                  \
  BURST_INFO(1, "Memory burst inferred: variable " + x + " in scope " + z +    \
...
#define CGPIP_INFO_1(x, y, z)                                                  \
  CGPIP_INFO(1, "Coarse-grained pipelining applied on loop " + x + "  " + y +  \
                    " nodes are scheduled into " + z + " pipeline stages ")
#define CGPAR_INFO_1(x)                                                        \
  CGPAR_INFO(1, "Coarse-grained parallelization applied: loop " + x)
#define FGPIP_INFO_2(x, y, z)                                                  \
  FGPIP_INFO(2, "Loop fine-grained parallelization applied: loop " + x + y +   \
                    "  parallel units:  " + z)
...
#define PROCS_WARNING_21(x)                                                    \
  PROCS_WARNING(                                                               \
      21, "Found an interface pragma without specified interface depth: " + x)
...
#define PROCS_WARNING_39(x)                                                    \
  PROCS_WARNING(39, "Cannot support pragma " + x + " with \'auto\' value.\n" + \
...
#define PROCS_WARNING_42(x)                                                    \
  PROCS_WARNING(42, "Pointer comparison detected " + x +                       \
                        "\n"                                                   \
...
#define PROCS_WARNING_43(x)                                                    \
  PROCS_WARNING(43, "Found a variable with multi-dimensional pointer"          \
                    " which is not assigned to any address spaces " +          \
                        x +                                                    \
                        "."                                                    \
                        " Vendor tool can not support this type"               \
                        " in accleration.")
#define PROCS_WARNING_44(x, y, z)                                              \
...
#define BURST_WARNING_1(x, y)                                                  \
  BURST_WARNING(                                                               \
      1, "Memory burst NOT inferred: variable " + x +                          \
             "\n"                                                              \
             "  Reason: the bound of the access range is not recognized (" +   \
             y +                                                               \
             ")\n"                                                             \
             "  Hint: please specify the bounds of the variables using "       \
             "'assert'")
#define BURST_WARNING_2(x, z, y, c)                                            \
  BURST_WARNING(2, "Memory burst inferred: variable " + x + " in scope " + z + \
                       "\n"                                                    \
...
#define WDBUS_WARNING_12(x)                                                    \
  WDBUS_WARNING(12, "Memory coalescing NOT inferred explicitly: variable " + x)
...
#define REDUC_WARNING_2(x)                                                     \
  REDUC_WARNING(                                                               \
      2, "Disable optimizing reduction on operation " + x +                    \
             " because of no benefit.\n" +                                     \
...
#define REDUC_WARNING_3(x)                                                     \
  REDUC_WARNING(3, "Stopping reduction analysis in loop " + x +                \
                       " because it is not canonical loop.")
#define REDUC_WARNING_4(x)                                                     \
  REDUC_WARNING(4, "Stopping reduction analysis in loop " + x +                \
                       " because it uses the outer loop's iterator in " +      \
                       "the loop bound expression.")
#define REDUC_WARNING_5(x, y)                                                  \
  REDUC_WARNING(5, "Stopping reduction analysis on variable '" + x +           \
                       "' in loop " + y + ": no valid reduction operation.")
#define REDUC_WARNING_6(x, y)                                                  \
  REDUC_WARNING(                                                               \
      6, "Stopping reduction analysis on variable '" + x + "' in loop " + y +  \
...
#define LINEBUF_INFO_1(x, y)                                                   \
  LINEBUF_INFO(1, "Applying line buffer on variable '" + x + "' in loop " + y)
...
#define CGPIP_WARNING_7(x, y)                                                  \
  CGPIP_WARNING(                                                               \
      7, "Coarse-grained pipelining NOT applied on loop " + x +                \
             "\n  Reason: multiple variable declarations in a statement " + y)
...
#define CGPAR_WARNING_1(x, y)                                                  \
  CGPAR_WARNING(1, "Coarse-grained parallelization NOT applied: loop " + x +   \
                       " because of access on the external memory port " + y)
#define CGPAR_WARNING_2(x, y)                                                  \
  CGPAR_WARNING(2, "Coarse-grained parallelization NOT applied: loop " + x +   \
                       " because of unsupported parallelism:\n" + y)
...
#define CGPAR_WARNING_10(x, y)                                                 \
  CGPAR_WARNING(10, "Coarse-grained parallelization NOT applied: loop " + x +  \
                        " because of unsupported task spawn:\n" + y)
#define CGPAR_WARNING_11(x, y)                                                 \
  CGPAR_WARNING(11,                                                            \
                "Coarse-grained parallelization NOT applied: loop " + x +      \
...
#define CGPAR_WARNING_12(x, y)                                                 \
  CGPAR_WARNING(                                                               \
      12, "Coarse-grained parallelization NOT applied: loop " + x +            \
              " because of access on non-constant local static variable " + y)
#define CGPAR_WARNING_13(x, y, z)                                              \
  CGPAR_WARNING(13, "Coarse-grained parallelization NOT applied: loop " + y +  \
                        " because access on array " + x +                      \
                        " cannot be parallelized due to " + z)

#define CGPAR_WARNING_14(y, z)                                                 \
  CGPAR_WARNING(14, "Coarse-grained parallelization NOT applied: loop " + y +  \
                        " because access on ports cannot be streamed due to "  \
                        "following reasons\n" +                                \
                        z)

#define LTILE_WARNING_1(x)                                                     \
  LTILE_WARNING(1, "Ignoring a loop tiling pragma for non-canonical loop: " + x)
...
#define LTILE_WARNING_4(x)                                                     \
  LTILE_WARNING(4,                                                             \
                "Cannot tile a loop with loop increment not equal to 1: " + x)
...
#define LTILE_WARNING_6(x)                                                     \
  LTILE_WARNING(6,                                                             \
                "Ignoring a loop tiling pragma for a tiling factor <=1: " + x)
...
#define LTILE_WARNING_8(x)                                                     \
  LTILE_WARNING(8, "Loop will be unrolled but without tiling because Factor "  \
                   ">= Loop Trip Count: " +                                    \
                       x)
...
#define LTILE_WARNING_10(x)                                                    \
  LTILE_WARNING(10, "Found in-divisible tiling on loop : " + x +               \
...
#define FGPIP_WARNING_12(x, y)                                                 \
  FGPIP_WARNING(12,                                                            \
                "Loop fine-grained parallelization CANNOT be applied: loop " + \
                    x + y +                                                    \
                    "because cannot completely unroll a loop with a variable " \
                    "trip count.")
#define FGPIP_WARNING_14(x, y, z, t)                                           \
  FGPIP_WARNING(                                                               \
      14,                                                                      \
      "Partitioning array " + y + " on dimension " + z + " with factor " + t + \
          "\n"                                                                 \
          "Note that loop " +                                                  \
          x + " probably cannot be fully-pipelined due to partially access " + \
          "conflicts of variable " + y)
#define FGPIP_WARNING_15(x, y, z, t)                                           \
  FGPIP_WARNING(15, "Suboptimal loop parallelization probably in Loop " + x +  \
                        " as " + "variable " + y + " dimension " + z +         \
                        " cannot be splitted into more than " + t +            \
                        " banks due to vendor tool's threshold.")
#define FGPIP_WARNING_16(x, y)                                                 \
  FGPIP_WARNING(16, "Loop fine-grained pipelining CANNOT be applied: loop " +  \
                        x + y +                                                \
                        " because the loop contains subloop(s) not being "     \
                        "unrolled or flattened.")
#define FGPIP_WARNING_17(x, y)                                                 \
  FGPIP_WARNING(                                                               \
      17,                                                                      \
      "To forcely apply pragma " + x +                                         \
          "  is risky because loop-carried dependence exists on variable " +   \
          y)
...
#define PROCS_WARNING_28(x, y)                                                 \
  PROCS_WARNING(28,                                                            \
                (x ? "Cannot recognize the lower bound for the expression "    \
                   : "Cannot recognize the upper bound for the expression ") + \
                    y + ", this may disable certain optimizations")
#define BURST_WARNING_15(x, y, z, tiled_loop, full_access)                     \
  BURST_WARNING(15,                                                            \
                "Low bandwidth efficiency of memory burst: variable " + x +    \
                    " in scope " + z + ".\n" +                                 \
                    "  Reason: short burst length = " + y + " bytes\n" +       \
                    (full_access ? " due to small external memory"             \
...
#define BURST_WARNING_16(x, y, r, s)                                           \
  BURST_WARNING(                                                               \
      16, "Stopping inferring longer memory burst: variable " + x +            \
              ...
              " bytes)  more than lifting threshold (" + s + " bytes).\n" +    \
...
#define BURST_WARNING_18(x, y, c, r, s)                                        \
  BURST_WARNING(18, "Stopping inferring longer memory burst: variable " + x +  \
                        " in scope " + y + ".\n" +                             \
                        "  Reason: required resource (" + r +                  \
...
#define PROCS_WARNING_15(x)                                                    \
  PROCS_WARNING(15, "Found an incomplete pragma: " +                           \
                        x) // ZP: to give more useful info, like the full format
                           // for the specific pragma
...
#define PROCS_WARNING_27(x)                                                    \
  PROCS_WARNING(27,                                                            \
                "Cannot support loop with the continue/break statement " + x)
...
#define DISAG_ERROR_3(x, y)                                                    \
  DISAG_ERROR(3, "Intel SDK cannot support more than " + x + " arguments.\n" + \
                     y +                                                       \
...
#define INFTF_ERROR_8(x, y, z)                                                 \
  INFTF_ERROR(8, "Found incorrect max_depth info '" + y + "'for port " + x +   \
                     "with dimension size " + z)
...
#define LTILE_ERROR_2(x)                                                       \
  LTILE_ERROR(                                                                 \
      2, "Cannot tile a loop with a bound not divisible by the factor: " + x)
...
#define FGPIP_ERROR_1(x, y)                                                    \
  FGPIP_ERROR(1, "Unable to completely unroll loop " + x + y +                 \
                     "because its trip count is variable.")
#define FGPIP_ERROR_2(x, y)                                                    \
  FGPIP_ERROR(2, "Loop fine-grained pipelining CANNOT be applied: loop " + x + \
                     y +                                                       \
...
#define FGPIP_INFO_4                                                           \
  FGPIP_INFO(                                                                  \
      4, "Automated loop flattening is turned off\n") // ZP: I understand auto
                                                      // loop flatten is
                                                      // globally turned off?
...
#define FUCIN_ERROR_1(x)                                                       \
  FUCIN_ERROR(1,                                                               \
              "Cannot support non-constant global variable in kernel: \n" + x)
...
#define PROCS_WARNING_25(x)                                                    \
  PROCS_WARNING(                                                               \
      25, "Found more than one loop with the accesses of a port array " + x +  \
...
#define COMCK_WARNING_2(x)                                                     \
  COMCK_WARNING(2,                                                             \
                "Cannot support the loop " + x + " without the simple bound.")
#define COMCK_WARNING_3(x)                                                     \
  COMCK_WARNING(3, "Cannot support loop with the continue/break statement " + x)

...
#ifndef _CMDLINE_PARSER_H_INCLUDED_
#define _CMDLINE_PARSER_H_INCLUDED_
...
public:
  ...
  string get_option(string flag, int idx = 0);
  string get_option_key_value(string flag, string key);
  int get_option_num(string flag);
...
#endif //_CMDLINE_PARSER_H_INCLUDED_
